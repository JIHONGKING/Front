						...
						items={[
							{
								...
								onClick: () =>
									console.log("Clicked searching for a job"),
							},
							{
								name: "Hiring someone",
								onClick: () =>
									console.log("Clicked hiring someone"),
							},
							{
								name: "Connecting with others",
								onClick: () =>
									console.log(
										"Clicked connecting with others"
									),
							},
							{
								name: "Network catch-up updates",
								onClick: () =>
									console.log("Clicked network updates"),
							},
							{
								name: "Posting and commenting",
								onClick: () =>
									console.log(
										"Clicked posting and commenting"
									),
							},
							{
								name: "Messaging",
							...
							},
							{
								...
								onClick: () =>
									console.log("Clicked attending events"),
							},
							{
								name: "News and reports",
								onClick: () =>
									console.log("Clicked news and reports"),
							},
							{
								name: "Updating your profile",
								onClick: () =>
									console.log("Clicked updating profile"),
							},
							{
								name: "Verifications",
								onClick: () =>
									console.log("Clicked verifications"),
							},
							{
								name: "Games",
