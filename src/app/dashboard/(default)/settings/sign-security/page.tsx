          ...
          <SettingSection 
            ...
            items={[
              { 
                ...
                content: (
                  <div>
                    <p className="mb-4">Primary email address</p>
                    <div className="p-3 bg-white rounded-md border border-gray-200 mb-4">
                      <p className="text-sm text-gray-600">example@wisc.edu</p>
                    </div>
                    <button className="text-blue-600 hover:underline text-sm">Add another email</button>
                  </div>
                )
              },
              { 
                ...
                content: (
                  <div>
                    <p className="mb-4">Add a phone number to help secure your account</p>
                    <button className="text-blue-600 hover:underline text-sm">Add phone number</button>
                  </div>
                )
              },
              { 
                ...
                content: (
                  <div>
                    <div className="bg-white p-3 rounded-md border border-gray-200 mb-3">
                      ...
                      <p className="text-sm text-gray-500">Last accessed: Just now</p>
                    </div>
                    <button className="text-blue-600 hover:underline text-sm">Remove all devices</button>
                  </div>
                )
              },
            ]} 
          ...
          <SettingSection 
            ...
            items={[
              { 
                ...
                content: (
                  <div>
                    <p className="mb-4">Add a security question to help protect your account</p>
                    <button className="bg-blue-600 text-white px-4 py-2 rounded-md text-sm hover:bg-blue-700">
              ...
              { 
                ...
                content: (
                  <div>
                    <p className="mb-2">Add recovery info to help you get back into your account if you're locked out</p>
                    <div className="space-x-4">
                      <button className="text-blue-600 hover:underline text-sm">Add recovery email</button>
                      <button className="text-blue-600 hover:underline text-sm">Add recovery phone</button>
                    </div>
                  </div>
                )
              },
