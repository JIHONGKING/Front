          ...
          <SettingSection 
            ...
            items={[
              { 
                ...
                content: (
                  <div>
                    <p className="mb-4 text-sm">Edit your basic information</p>
              ...
              { 
                ...
                content: (
                  <div>
                    <p className="mb-4 text-sm">This information helps us provide better job recommendations</p>
                    <div className="space-y-4">
                      <div>
              ...
              { 
                ...
                content: (
                  <div>
                    <p className="mb-4 text-sm">Verify your account to access all features</p>
          ...
          <SettingSection 
            ...
            items={[
              { 
                name: "Dark mode",
                disabled: true,
                content: <p className="text-sm">Dark mode is currently not available.</p>
              },
            ]} 
          />
          ...
          <SettingSection 
            ...
            items={[
              { 
                ...
                content: (
                  <div>
                    <p className="mb-4 text-sm">Select your preferred language</p>
                    <select className="w-full p-2.5 border border-gray-200 rounded-md text-sm appearance-none bg-white">
              ...
              { 
                ...
                content: (
                  <div>
                    <p className="mb-4 text-sm">Choose how profile photos are displayed</p>
                    <div className="space-y-3">
                      <label className="flex items-center">
                        <input type="radio" name="photos" className="mr-2" />
                        <span className="text-sm">Show all profile photos</span>
                      </label>
                      <label className="flex items-center">
                        <input type="radio" name="photos" className="mr-2" />
                        <span className="text-sm">Hide all profile photos</span>
                      </label>
                    </div>
                  </div>
                )
          ...
          <SettingSection 
            ...
            items={[
              { 
                ...
                content: (
                  <div>
                    <p className="text-red-600 font-medium mb-4 text-sm">Warning: This action cannot be undone.</p>
                    <p className="mb-4 text-sm">Closing your account will permanently delete all your data.</p>
