...
const menuItems = [
	...
	},
	{
		...
		icon: secure,
		text: "Sign & security",
		path: "/dashboard/settings/sign-security",
	},
	{
		id: "visibility",
		icon: Eye_light,
		text: "Visibility",
		path: "/dashboard/settings/visibility",
	},
	{
		id: "privacy",
		icon: chield_light,
		text: "Data privacy",
		path: "/dashboard/settings/data-privacy",
	},
	{
		id: "notifications",
		icon: Bell_light,
...
export default function SettingsLayout({
	...
	return (
		<div className="flex flex-row h-full max-h-full  bg-[#F5F6F8]">
			{/* Left Sidebar */}
			...
			{/* Main Content */}
			<div className="flex-1 ml-6 mr-6 h-full max-h-full">
