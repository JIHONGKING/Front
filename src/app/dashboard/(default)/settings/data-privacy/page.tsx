        ...
        <div className="space-y-[17px]">
          <SettingSection 
            ...
            items={[
              { 
                ...
                onClick: () => console.log("Clicked manage data")
              },
              { 
                name: "Get a copy of your data",
                onClick: () => console.log("Clicked get data copy")
              },
              {
                name: "Search history",
                onClick: () => console.log("Clicked search history")
              },
              {
                name: "Personal demographic information",
                onClick: () => console.log("Clicked demographic info")
              },
              {
                name: "Social, economic, and workplace research",
                onClick: () => console.log("Clicked research")
              },
              {
                name: "Data for Generative AI improvement",
                onClick: () => console.log("Clicked AI data")
              }
            ]}
          />
          ...
          <SettingSection 
            ...
            items={[
              { 
                ...
                onClick: () => console.log("Clicked invitations")
              },
              {
                name: "Invitations from your network",
                onClick: () => console.log("Clicked network invitations")
              },
              {
                name: "Messages",
              ...
              },
              {
                ...
                onClick: () => console.log("Clicked research invites")
              }
            ]}
          />
          ...
          <SettingSection 
            ...
            items={[
              { 
                name: "Focused inbox",
                onClick: () => console.log("Clicked focused inbox")
              },
              {
                name: "Read receipts and typing indicators",
                onClick: () => console.log("Clicked read receipts")
              },
              {
                name: "Messaging suggestions",
                onClick: () => console.log("Clicked suggestions")
              },
              {
                name: "Message nudges",
                onClick: () => console.log("Clicked nudges")
              },
              {
                name: "Automated detection of harmful content",
                onClick: () => console.log("Clicked harmful content")
              }
            ]}
          />
          ...
          <SettingSection 
            ...
            items={[
              ...
              },
              {
                ...
                onClick: () => console.log("Clicked shared accounts")
              }
            ]}
          />
